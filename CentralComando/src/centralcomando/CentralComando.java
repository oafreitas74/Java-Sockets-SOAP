...
public class CentralComando extends Thread{
    private Socket ligacaoCelula = null;
    private static int nLigacoes = 0;
    
    public CentralComando (Socket ligacaoCelula)
    {
     ...
     try
        {
            ...
            while(true)
            {
                    ...
                    Thread t = new CentralComando(ligacaoCelula);
                    t.start();           
            }
    ...
    public void TratarMsgInserir(String msg)
    {
        ...
        inserirDados(tipo, nEscuta, nCelula, dados);
    ...
    public void run()
    {
        ...
        try {
            ...
            //Ler dados da entrada...enviados pelo Celula
            String msg = "";
    ...
    private static Boolean inserirDados(java.lang.String tipo, java.lang.String nomeEscuta, java.lang.String nomeCeluda, java.lang.String dados) {
        com.sd.ws.WSEscutas_Service service = new com.sd.ws.WSEscutas_Service();
        com.sd.ws.WSEscutas port = service.getWSEscutasPort();
        return port.inserirDados(tipo, nomeEscuta, nomeCeluda, dados);
    }
